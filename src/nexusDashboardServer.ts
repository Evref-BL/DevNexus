...
export function renderNexusDashboardClientModule(): string {
  return [
    ...
    "  if (focus === 'eligible-work') return actions.filter((action) => action.kind === 'dirty');",
    "  if (focus === 'plugins') {",
    ...
    "  if (focus === 'eligible-work') return workspaces.filter((workspace) => workspace.dirtyComponentCount > 0);",
    ...
    "  if (focus === 'eligible-work') return 'Dirty Checkouts';",
    ...
    "  if (focus === 'eligible-work') return 'Dirty Workspaces';",
    ...
    "  if (focus === 'eligible-work') return 'No dirty checkout needs rescue.';",
    ...
    "  if (focus === 'eligible-work') return 'No workspace has dirty component checkouts.';",
