...
export function renderNexusDashboardClientModule(): string {
  return [
    ...
    ".dn-header-path-menu { flex: 1 1 430px; min-width: min(100%, 430px); }",
    ".dn-header-path-control { display: grid; grid-template-columns: auto minmax(0, 1fr) auto; align-items: center; gap: 10px; width: 100%; min-height: 52px; padding: 8px 8px 8px 10px; border: 1px solid color-mix(in srgb, var(--dn-active) 22%, var(--dn-border)); border-radius: 8px; color: var(--dn-strong); background: color-mix(in srgb, var(--dn-surface) 72%, var(--dn-active) 12%); cursor: pointer; }",
    ".dn-header-path-control:hover { border-color: color-mix(in srgb, var(--dn-border-strong) 46%, var(--dn-active) 54%); background: color-mix(in srgb, var(--dn-surface) 64%, var(--dn-active) 18%); }",
    ...
    ".dn-open-menu[open] .dn-open-trigger, .dn-open-menu[open] .dn-header-path-control { border-color: color-mix(in srgb, var(--dn-border-strong) 34%, var(--dn-active) 66%); background: color-mix(in srgb, var(--dn-surface) 82%, var(--dn-active) 18%); }",
    ...
    "@media (max-width: 860px) { .dn-header { grid-template-columns: 1fr; } .dn-header-actions { justify-content: stretch; width: 100%; } .dn-header-strip, .dn-header-path-menu { width: 100%; } }",
