...
function readNexusCockpitAuditSource(): string {
  const candidates = [
    ...
    "../client/nexusCockpitHostViews.js",
    "../client/nexusCockpitHostViews.ts",
    "../client/nexusCockpitRenderState.js",
    "../client/nexusCockpitRenderState.ts",
    "../client/nexusCockpitStyles.js",
    "../client/nexusCockpitStyles.ts",
    "../client/nexusCockpitTheme.js",
    "../client/nexusCockpitTheme.ts",
