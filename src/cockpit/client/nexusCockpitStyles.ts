...
.dn-history-scopes { --dn-history-scope-count: 0; --dn-history-scope-token-max-width: 170px; --dn-history-scope-group-max-width: auto; display: inline-flex; flex: 0 0 auto; gap: 4px; min-width: 0; max-width: min(68%, var(--dn-history-scope-group-max-width)); overflow: hidden; }
