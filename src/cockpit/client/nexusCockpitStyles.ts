...
.dn-history-scopes { --dn-history-scope-token-width: 64px; display: inline-flex; flex: 0 1 auto; gap: 4px; max-width: 48%; overflow: hidden; }
...
.dn-history-scopes .dn-history-scope-token { flex: 0 0 var(--dn-history-scope-token-width); width: var(--dn-history-scope-token-width); max-width: var(--dn-history-scope-token-width); }
