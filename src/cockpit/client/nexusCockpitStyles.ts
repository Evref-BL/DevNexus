...
:root { --dn-grid-line: rgba(180, 210, 188, 0.055); --dn-shadow: 0 22px 60px rgba(0, 0, 0, 0.28); --dn-branch-0: #1587d7; --dn-branch-1: #d9369d; --dn-branch-2: #1fcf39; --dn-branch-3: #d89118; --dn-branch-4: #a454d9; --dn-branch-5: #f05252; --dn-branch-6: #22cfc7; --dn-branch-7: #e05bea; --dn-branch-8: #8bd13a; --dn-branch-9: #dc6b32; --dn-branch-10: #7657d8; --dn-branch-11: #e9c933; --dn-branch-faint: rgba(238, 245, 236, 0.16); }
:root[data-dev-nexus-theme='light'] { --dn-grid-line: rgba(31, 115, 93, 0.085); --dn-shadow: 0 18px 40px rgba(34, 50, 42, 0.1); --dn-branch-0: #086fb5; --dn-branch-1: #b31778; --dn-branch-2: #138e2b; --dn-branch-3: #a86800; --dn-branch-4: #7c2db8; --dn-branch-5: #c53030; --dn-branch-6: #007f79; --dn-branch-7: #b93bc4; --dn-branch-8: #5f9700; --dn-branch-9: #ad4b1d; --dn-branch-10: #5532b8; --dn-branch-11: #a78000; --dn-branch-faint: rgba(22, 35, 27, 0.14); }
...
.dn-history-scope-token { --dn-scope-color: var(--dn-active); display: inline-grid; grid-template-columns: auto minmax(0, 1fr); align-items: center; max-width: 170px; min-width: 0; overflow: hidden; border: 1px solid color-mix(in srgb, var(--dn-scope-color) 42%, var(--dn-border)); border-radius: 7px; color: var(--dn-pill-text); background: color-mix(in srgb, var(--dn-surface-raised) 88%, var(--dn-scope-color) 12%); font-size: 0.66rem; font-weight: 820; white-space: nowrap; }
.dn-history-scope-kind { align-self: stretch; display: inline-flex; align-items: center; padding: 1px 5px; color: var(--dn-bg); background: var(--dn-scope-color); font-size: 0.56rem; font-weight: 950; text-transform: uppercase; }
.dn-history-scope-name { min-width: 0; overflow: hidden; padding: 1px 6px; text-overflow: ellipsis; white-space: nowrap; }
