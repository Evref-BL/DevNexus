...
} from "../mcp/nexusCoreMcpTools.js";
import {
  isNexusMcpExposureMode,
  type NexusMcpExposureMode,
} from "../mcp/nexusMcpExposureTypes.js";
import type {
  NexusMcpGatewayPolicyConfig,
  NexusProjectActiveAgentMcpSettings,
  NexusProjectActiveAgentProvider,
  NexusProjectActiveAgentSkillSettings,
  NexusProjectActiveAgentTargetConfig,
  NexusProjectAgentMcpConfigFormat,
  NexusProjectAgentMcpTarget,
  NexusProjectAgentProjectionSource,
  NexusProjectAgentTargetsConfig,
  NexusProjectMcpConfig,
  NormalizedNexusProjectAgentProjection,
...
import type { NexusProjectHostingConfig } from "./nexusProjectHosting.js";
import type { NexusProjectHostConfig } from "../hosts/nexusHostRegistry.js";
import {
...
import { validateNexusCiTierPolicyConfig } from "../operations/nexusCiTierPolicy.js";
import {
...
import {
  ...
  requiredDependencyProjectionTargetPath,
  requiredProjectRelativePath,
  requiredString,
} from "./nexusProjectConfigValidation.js";
import { validateProjectHostingConfig } from "./nexusProjectHostingConfig.js";
import {
  validateComponentWorkTrackers,
  validateTrackerCommunicationPolicy,
  validateTrackerDiscoveryPolicy,
  validateWorkTrackingConfig,
} from "./nexusProjectWorkTrackingConfig.js";
import type {
  NexusProjectTrackerCommunicationPolicyConfig,
  NexusProjectTrackerDiscoveryPolicyConfig,
  NexusProjectWorkTrackerBindingConfig,
} from "./nexusProjectWorkTrackingConfig.js";
export { NexusConfigError } from "./nexusProjectConfigValidation.js";
export {
  defaultNexusProjectTrackerCommunicationPolicy,
  defaultNexusProjectTrackerDiscoveryPolicy,
  normalizeComponentWorkTrackers,
  normalizeNexusProjectTrackerCommunicationPolicy,
  normalizeNexusProjectTrackerDiscoveryPolicy,
} from "./nexusProjectWorkTrackingConfig.js";
export type {
  NexusProjectTrackerCommunicationPolicyConfig,
...
function validateMcpExposureMode(
  ...
  if (isNexusMcpExposureMode(value)) {
    return value;
  }
