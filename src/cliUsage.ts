export function usage(): string {
  return [
    ...
    "  dev-nexus publication initiative-plan <workspace-root> [options]",
    "  dev-nexus publication initiative-report <workspace-root> [options]",
    ...
    "  --json",
    "",
    "Options for publication initiative-plan:",
    "  --component <id>          limit the plan to one component",
    "  --initiative <id>         limit the plan to one active initiative/scope id",
    "  --json",
    "",
    "Options for publication initiative-report:",
    "  --component <id>          limit the report to one component",
    "  --initiative <id>         limit the report to one active initiative/scope id",
    "  --evidence-file <json>    provider evidence array, {\"evidence\": [...]}, or {\"providerEvidence\": [...]}",
    "  --full-matrix-budget-available",
    "  --full-matrix-budget-exhausted",
    "  --json",
    "",
    "Options for publication initiative-finalization:",
    "  --component <id>          limit the plan to one component",
    "  --initiative <id>         limit the plan to one active initiative/scope id",
    "  --evidence-file <json>    provider evidence array, {\"evidence\": [...]}, or {\"providerEvidence\": [...]}",
    "  --full-matrix-budget-available",
