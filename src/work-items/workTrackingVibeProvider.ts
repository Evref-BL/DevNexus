...
} from "../integrations/vibe-kanban/vibeKanbanBoardAdapter.js";
import {
  registerVibeKanbanProject,
  type RegisterVibeKanbanProjectResult,
} from "../integrations/vibe-kanban/vibeKanbanProjectAdapter.js";
import type { VibeKanbanApiOptions } from "../integrations/vibe-kanban/vibeKanbanApi.js";
import type {
  CreateWorkItemInput,
  NexusProjectContext,
  TrackerBoardRef,
