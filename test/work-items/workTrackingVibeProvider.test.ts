...
} from "../../src/work-items/workTrackingVibeProvider.js";
...
describe("Vibe work tracker provider", () => {
  it("registers the component source root as the Vibe project", async () => {
    const fetchMock = vi.fn(
      async (_input: string | URL | Request, _init?: RequestInit) =>
        jsonResponse({
          ...
          data: {
            id: "repo-1",
            path: "C:\\dev\\code\\git\\ExampleProject",
    ...
    const result = await provider.ensureProject({
      homePath: "C:\\dev\\code\\nexus-home",
      projectRoot: "C:\\dev\\code\\nexus-home\\ExampleProject",
      sourceRoot: "C:\\dev\\code\\git\\ExampleProject",
