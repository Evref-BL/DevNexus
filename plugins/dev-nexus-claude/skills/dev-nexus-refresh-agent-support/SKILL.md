...
description: Refresh DevNexus-projected Claude Code skills and MCP configuration.
---

# DevNexus Refresh Agent Support

Use this skill when Claude Code needs refreshed DevNexus support files,
projected skills, or MCP configuration for the current workspace.
