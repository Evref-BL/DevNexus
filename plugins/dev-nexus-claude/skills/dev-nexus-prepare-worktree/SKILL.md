...
description: Prepare an isolated DevNexus worktree before changing managed files from Claude Code.
---

# DevNexus Prepare Worktree

Use this skill when Claude Code is asked to implement, document, or otherwise
mutate a DevNexus-managed component or workspace surface.
